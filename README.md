...
- 易思维（杭州）科技有限公司的前端开发工程师
- 农学出身，转到前端
- 技术栈: vue、node、flask、爬虫、深度学习等，正在学习中...
- 未来希望可以给大家带来更多的教程
...
![img](https://pica.zhimg.com/80/v2-c327c810e7b80cd27568e92d5a6d5721_720w.webp?source=1940ef5c)
...
![image-20230111133916643](C:\Users\simon\AppData\Roaming\Typora\typora-user-images\image-20230111133916643.png)
...
// value = "杨紫";// 报错
// value = true;// 报错
// 注意点: null和undefined是所有类型的子类型(除了never), 所以我们可以将null和undefined赋值给任意类型(除了never)
// 严格模式下会null报错
// value = null; // 不会报错  
...
//  即使 any也不可以赋值给never，null和undefined也不行。
...
```js
function disp(a:string, b:string):number
function disp(a:string, b:string):string // 不能构成重载
```
